...
let kirell = GameCharacter(name: "kirell", profileImage: <#T##String#>, backGroundImage: <#T##String#>, infomation: <#T##[String]#>, Mission: <#T##String#>, likability: <#T##Int#>)

let santa = User(setting: santaSetting, tickets: 0, currentHistories: <#T##[History]#>, currentAchievements: <#T##[Achievement]#>, currentCharacterInfo: currentGameCharacter)
let santaSetting = Setting(langueage: .Korean, bgmVolume: 0.0, effectVolume: 0.0, textSpeed: 0.1)
let currentGameCharacter = GameCharacters(
    kirell: kirell,
    hilde: GameCharacter(name: <#T##String#>, profileImage: <#T##String#>, backGroundImage: <#T##String#>, infomation: <#T##[String]#>, Mission: <#T##String#>, likability: <#T##Int#>),
    argo: GameCharacter(name: <#T##String#>, profileImage: <#T##String#>, backGroundImage: <#T##String#>, infomation: <#T##[String]#>, Mission: <#T##String#>, likability: <#T##Int#>),
    philio: GameCharacter(name: <#T##String#>, profileImage: <#T##String#>, backGroundImage: <#T##String#>, infomation: <#T##[String]#>, Mission: <#T##String#>, likability: <#T##Int#>),
    balaam: GameCharacter(name: <#T##String#>, profileImage: <#T##String#>, backGroundImage: <#T##String#>, infomation: <#T##[String]#>, Mission: <#T##String#>, likability: <#T##Int#>))

let adsf = Chat(text: "", image: nil, type: .animationPopup, who: kirell, nextTextIndex: 0, characterFace: false)
