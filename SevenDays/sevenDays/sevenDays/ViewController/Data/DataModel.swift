...
var currentCharactersInfo: [String:GameCharacter]
    ...
    = ["kirell":GameCharacter(name: "키렐", profileImage: "kirell", backgroundImage: "", infomation: [], mission: "나침반을 따라가라.", likability: 0),
        ...
        "wolf":GameCharacter(name: "울프", profileImage: "wolf", backgroundImage: "", infomation: [], mission: "나침반을 따라가라.", likability: 0),
        ...
        "philio":GameCharacter(name: "필리오", profileImage: "philio", backgroundImage: "", infomation: [], mission: "나침반을 따라가라.", likability: 0),]
