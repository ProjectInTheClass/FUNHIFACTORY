...
var chapter1 = Episode(episodeID: "1592", episodePlace: "인정전", episodeYear: 1592, episodeKingYear: "선조 25년", episodeShortDesciption: "우리나라의 뼈아픈 역사 중 하나다. ",episodeDesciption: "임진왜란 때 대부분의 궁궐이 화재로 인해 소실되었다.", episodePlaceImage: "Donhwamun image", episodeCoverImage: "changdeokgung image sample", isCleared: true, chatHistory: [], storyBlocks: [
                        ...
                        "001":BlockOfDayEpisode(chats:
                                                                [
                                                                    ...
                                                                    Chat(text: "장작을 좀 찾아보렴.", image: "", type: .onlyText, who: .hwiryeong, characterFace: .basic, optionalOption: OptionalOption(achievementToUnlock: .geumcheongyo, infomationToUnlock: .hwiryeong4, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil /*,checkPointToUnlock: .id201*/), animationOption: .none),
                                                                    Chat(text: "네.", image: "", type: .onlyText, who: .danhee, characterFace: .basic, optionalOption: nil, animationOption: .none),
                                                                    Chat(text: "장작이 어디 가면 있을까?", image: "", type: .monologue, who: .danhee, characterFace: .basic, optionalOption: OptionalOption(achievementToUnlock: .necklace, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil/*,checkPointToUnlock: .id201*/), animationOption: .fadeOut),
...
//                                                                    Chat(text: "네.", image: "", type: .onlyText, who: .danhee, characterFace: .basic, achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .fadeIn),
...
//                                                                    Chat(text: "돌무더기 아래에는..", image: "", type: .monologue, who: .danhee, characterFace: .basic, achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none)],
                        ...
                        choices: [
                            Choice(text: "장작이 한 개 있었어.", chatType: .monologue, characterFace: .basic, nextTextIndex: "002", optionalOption: OptionalOption(achievementToUnlock: .injeongjeon, infomationToUnlock: .kimjajeom2, gameCharacterToUnlock: .hwiryeong, caseToUnlock: .case301, albumImageToUnlock: .chapter2case3/*,checkPointToUnlock: .id201*/)),
...
choices: [
    ...
    Choice(text: "장작이 두 개 있었어.", chatType: .onlyText, characterFace: .basic, nextTextIndex: "002", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil),
                        ...
                        */:], currentCharacterNote: [], currentCaseNote: [], currentAlbumImages: [], timelineCheckPoint: [])

var endingChapter = Episode(episodeID: "ending", episodePlace: "엔딩", episodeYear: 2020, episodeKingYear: "엔딩 에피소드입니다.\n\n(샘플 텍스트입니다)", episodeShortDesciption: "", episodeDesciption: "", episodePlaceImage: "", episodeCoverImage: "", isCleared: false, chatHistory: [], storyBlocks: [:], currentCharacterNote: [], currentCaseNote: [], currentAlbumImages: [], timelineCheckPoint: [])
