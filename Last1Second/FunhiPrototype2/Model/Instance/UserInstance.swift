...
currentCaseNote: [], currentAlbumImages: [], timelineCheckPoint: [], currentStoryBlockIndex: "001"),
    ...
    GameCharacter(name: "김상궁", profileImage: "kimwoman", backGroundImage: "", description: "돈이 최고지~\n왕은 나를 제일 사랑하신다고.\n내가 없으면 이 나라는 돌아가지 않아.", infomation: [
        ...
        Infomation(infomationID: .kimsanggung5, isLocked: false, text: "후궁이 되는 것을 거부하여 계속 상궁의 신분을 유지하였다. 그 덕에 자유롭게 궐 밖으로 돌아다닐 수 있어 다양한 정보를 확보할 수 있었다."),
                    Infomation(infomationID: .kimsanggung6, isLocked: false, text: "광해군이 그녀를 아끼고 신뢰를 하면서 후궁보다 권세가 더 높았다고 하니...대단한걸."),],isLocked: true, isChecked: true),
    ...
    GameCharacter(name: "가난한 평민", profileImage: "poorman", backGroundImage: "", description: "거기 누구요?!\n이곳엔 더 이상 가져갈 것도 없으니\n썩 물러가시오!", infomation: [
        Infomation(infomationID: .kimjajeom2, isLocked: false, text: "마을 끝자락에 위치한 가난한 사람들끼리 뭉쳐있는 곳에 살고 있는 사람이다."),
                    Infomation(infomationID: .kimjajeom2, isLocked: false, text: "생각보다 경계심이 있네.")],isLocked: true, isChecked: true),
...
currentAlbumImages: [
        ...
        AlbumImage(id: .conference_hall, image: "conference_hall", title: "반란의 회의장", description: "내 앞에 있는 사람들은\n회의를 하는 것처럼 보인다.\n\n그런데 그 내용이...\n반정을 일으킨다는 것이라니.\n\n내가 반역자의 한 명이 될 수도 있다는 건가?", isLocked: true),
        AlbumImage(id: .bribe, image: "bribe", title: "뇌물", description: "나도 모르게 뇌물을 전해버렸어...\n이걸 전해주면 이번 사건은\n틀림없이 실패할 텐데.", isLocked: true),
        AlbumImage(id: .huijeongdang_fire, image: "huijeongdang_fire", title: "불타는 희정당", description: "불길이 건물을 덮치고 그에도 부족했는지\n하늘까지 온통 검게 변했다.\n\n내가.... 내가 막았으면 됐는데...\n도대체 내가 무슨 짓을 한 거야?", isLocked: true),
        AlbumImage(id: .huwon_garden_fire, image: "huwon_garden_fire", title: "후원의 화재", description: "분명... 분명 좀 전까지만 해도\n황홀한 풍경이었는데....\n\n이 모습도 어떻게 보면\n황홀한 광경이라고 할 수 있을까..\n\n다시 시간을 돌려서 이 모습을 구하고 싶어.", isLocked: true),
        AlbumImage(id: .revolt_image, image: "revolt_image", title: "반란의 시작점", description: "내 옆에는 많은 군사들이 있고,\n나는 지금 돈화문 앞이다.\n\n“다들 정신 똑바로 차리거라!!\n이 문만 지나가면 우리의 세상이 오는 것이니!”\n\n무섭게도 소리 지르는 군사들을 보니\n등골이 서름해지면서 실감이 났다.\n\n아, 내가 인조반정 날에 왔구나.", isLocked: true)],

timelineCheckPoint: [
        [CheckPoint(id: .checkPoint_2_0_1, name: "처음부터", storyBlockIndex: "001", isLocked: true),
         CheckPoint(id: .checkPoint_2_0_2, name: "반란을 도모하는 회의장", storyBlockIndex: "046", isLocked: true),
         CheckPoint(id: .checkPoint_2_0_3, name: "김상궁과의 만남", storyBlockIndex: "104", isLocked: true)],
    
        [CheckPoint(id: .checkPoint_2_1_1, name: "첫 번째 거짓말", storyBlockIndex: "132", isLocked: true),
         CheckPoint(id: .checkPoint_2_1_2, name: "두 번째 거짓말", storyBlockIndex: "137", isLocked: true),
         CheckPoint(id: .checkPoint_2_1_3, name: "세 번째 거짓말", storyBlockIndex: "149", isLocked: true)],
    
        [CheckPoint(id: .checkPoint_2_2_1, name: "휘령의 호통", storyBlockIndex: "219", isLocked: true),
         CheckPoint(id: .checkPoint_2_2_2, name: "백문이 불여일견", storyBlockIndex: "239", isLocked: true),
         CheckPoint(id: .checkPoint_2_2_3, name: "또 한 번의 기회", storyBlockIndex: "254", isLocked: true)]
        ], currentStoryBlockIndex: "001"),
                      Episode(episodeID: "1803", episodePlace: "인정전", episodeYear: 1803, episodeKingYear: "순조 3년", episodeShortDesciption: "왕의 나이가 너무 어려 대비가 대신 정치를 했다. 그 과정에서 한쪽 세력에만 힘을 실게 되고, 종교의 자유를 억압하게 되었다. 복수심을 가지고 있는 자가 이번 사건의 범인일지도.", episodeDesciption: "대한독립 만세",episodePlaceImage: "injeongjeon illust", episodeCoverImage: "changdeokgung image sample",  chatHistory: [],storyBlocks: [:], currentCharacterNote: [], currentCaseNote: [], currentAlbumImages: [], timelineCheckPoint: [], currentStoryBlockIndex: ""),
                      Episode(episodeID: "1918", episodePlace: "대조전", episodeYear: 1918, episodeKingYear: "순종 11년", episodeShortDesciption: "", episodeDesciption: "7월 28일임",episodePlaceImage: "daejojeon illust", episodeCoverImage: "changdeokgung image sample", chatHistory: [], storyBlocks: [:], currentCharacterNote: [], currentCaseNote: [], currentAlbumImages: [], timelineCheckPoint: [], currentStoryBlockIndex: ""),
                      Episode(episodeID: "ending", episodePlace: "엔딩", episodeYear: 2020, episodeKingYear: "엔딩 에피소드입니다.\n\n(샘플 텍스트입니다)", episodeShortDesciption: "", episodeDesciption: "", episodePlaceImage: "", episodeCoverImage: "", chatHistory: [], storyBlocks: [:], currentCharacterNote: [], currentCaseNote: [], currentAlbumImages: [], timelineCheckPoint: [], currentStoryBlockIndex: "" )],
    ...
    dayIndex: 0, dayId: "prologue", currentChatId: "001", currentChatArray: [])

var timer:Timer!

let extraCharacters : [GameCharacter] = [
  GameCharacter(name: "모두", profileImage: "everyone", backGroundImage: "", description: "", infomation: [], isLocked: false, isChecked: true),
  GameCharacter(name: "반역자 1", profileImage: "extra1", backGroundImage: "", description: "", infomation: [], isLocked: false, isChecked: true),
  GameCharacter(name: "반역자 2", profileImage: "extra2", backGroundImage: "", description: "", infomation: [], isLocked: false, isChecked: true),
  GameCharacter(name: "반역자 3", profileImage: "extra3", backGroundImage: "", description: "", infomation: [], isLocked: false, isChecked: true),
  GameCharacter(name: "군사 대장", profileImage: "extra4", backGroundImage: "", description: "", infomation: [], isLocked: false, isChecked: true),
    GameCharacter(name: "반란군", profileImage: "extra5", backGroundImage: "", description: "", infomation: [], isLocked: false, isChecked: true)]
