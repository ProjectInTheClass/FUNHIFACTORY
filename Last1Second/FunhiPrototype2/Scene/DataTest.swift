...
func testData() {
//  player.currentEpisodes[0].chatHistory = [Chat(text_: "", image_: "", type_: .onlyText, who_: .danhee, characterFace_: .angry1, optionalOption_: nil, animationOption_: .none, isGod_: false)]
