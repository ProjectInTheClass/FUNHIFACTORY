...
var chapter1 = Episode(episodeID: "1592", episodePlace: "인정전", episodeYear: 1592, episodeKingYear: "선조 25년", episodeShortDesciption: "우리나라의 뼈아픈 역사 중 하나다. ",episodeDesciption: "임진왜란 때 대부분의 궁궐이 화재로 인해 소실되었다.", episodePlaceImage: "Donhwamun image", episodeCoverImage: "changdeokgung image sample", isCleared: true, chatHistory: [], storyBlocks: [
                        ...
                        "001":BlockOfDayEpisode(chats:
                                                                [
                                                                    ...
                                                                    Chat(text_: "장작을 좀 찾아보렴.", image_: "", type_: .onlyText, who_: .hwiryeong, characterFace_: .basic, optionalOption_: OptionalOption(achieve: .geumcheongyo, inform: .hwiryeong4, gamecharacter: nil, cases: nil, album: nil, check: .id201), animationOption_: .none),
                                                                    Chat(text_: "네.", image_: "", type_: .onlyText, who_: .danhee, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                                                    Chat(text_: "장작이 어디 가면 있을까?", image_: "", type_: .monologue, who_: .danhee, characterFace_: .basic, optionalOption_: OptionalOption(achieve: .necklace, inform: nil, gamecharacter: nil, cases: nil, album: nil, check: .id201), animationOption_: .fadeOut),
                                                                    Chat(text_: "단희는 고개를 두리번거리다가 돌무더기를 발견했다.", image_: "", type_: .sectionHeader, who_: .danhee, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                                                    Chat(text_: "왜인지 저기를 들추면 \n장작이 있을 것만 같아.", image_: "", type_: .monologue, who_: .danhee, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                                                    Chat(text_: "들춰보자.", image_: "", type_: .onlyText, who_: .danhee, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                                                    Chat(text_: "단희는 돌무더기 앞으로 향했다.", image_: "", type_: .sectionHeader, who_: .hwiryeong, characterFace_: .basic, optionalOption_: nil, animationOption_: .fadeIn),
                                                                    Chat(text_: "돌무더기를 들춰보러 이동합니다.", image_: "", type_: .sectionHeader, who_: .hwiryeong, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                                                    Chat(text_: "돌무더기 아래에는..", image_: "", type_: .monologue, who_: .danhee, characterFace_: .basic, optionalOption_: nil, animationOption_: .none)],

//                                                                    Chat(text: "장작을 좀 찾아보렴.", image: "", type: .onlyText, who: .hwiryeong, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none),
//                                                                    Chat(text: "네.", image: "", type: .onlyText, who: .danhee, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .fadeIn),
//                                                                    Chat(text: "장작이 어디 가면 있을까?", image: "", type: .monologue, who: .danhee, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .fadeOut),
//                                                                    Chat(text: "단희는 고개를 두리번거리다가 돌무더기를 발견했다.", image: "", type: .sectionHeader, who: .danhee, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none),
//                                                                    Chat(text: "왜인지 저기를 들추면 \n장작이 있을 것만 같아.", image: "", type: .monologue, who: .danhee, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none),
//                                                                    Chat(text: "들춰보자.", image: "", type: .onlyText, who: .danhee, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none),
//                                                                    Chat(text: "단희는 돌무더기 앞으로 향했다.", image: "", type: .sectionHeader, who: .hwiryeong, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none),
//                                                                    Chat(text: "돌무더기를 들춰보러 이동합니다.", image: "", type: .sectionHeader, who: .hwiryeong, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none),
//                                                                    Chat(text: "돌무더기 아래에는..", image: "", type: .monologue, who: .danhee, characterFace: .basic, achieve: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil, animationOption: .none)],

                        choices: [
                            Choice(text_: "장작이 한 개 있었어.", chatType_: .monologue, characterFace_: .basic, nextTextIndex_: "002", optionalOption_: OptionalOption(achieve: .injeongjeon, inform: .kimjajeom2, gamecharacter: .hwiryeong, cases: .case301, album: .chapter2case3, check: .id201)),
                            Choice(text_: "장작이 두 개 있었어.", chatType_: .onlyText, characterFace_: .basic, nextTextIndex_: "003", optionalOption_: nil),
                        ], choiceSkip: false, isGodChat: false, backGroundMusic: .normal),
            
            "002":BlockOfDayEpisode(chats:
                                        [

                                            Chat(text_: "아닌 것 같아. 다시 찾아보자.", image_: "", type_: .monologue, who_: .danhee, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                            Chat(text_: "다시 돌무더기를 들여다봐야겠어.", image_: "", type_: .sectionHeader, who_: .hwiryeong, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                            Chat(text_: "돌무더기를 들춰보러 이동합니당.", image_: "", type_: .sectionHeader, who_: .hwiryeong, characterFace_: .basic, optionalOption_: nil, animationOption_: .none),
                                            Chat(text_: "돌무더기 아래에는..", image_: "", type_: .monologue, who_: .danhee, characterFace_: .basic, optionalOption_: nil, animationOption_: .none)
                                        ],


        choices: [
            Choice(text_: "장작이 한 개 있었어.", chatType_: .monologue, characterFace_: .basic, nextTextIndex_: "001", optionalOption_: nil),
            Choice(text_: "장작이 두 개 있었어.", chatType_: .onlyText, characterFace_: .basic, nextTextIndex_: "002", optionalOption_: nil)
...
currentCaseNote: [NoteCase(id: .case201, title: "[인조반정]", shortDescription: "1623년 4월 11일에 일어난 사건이다.", longDescription: "1623년 4월 11일에 일어난 사건이다. 조선의 3대 반정 중 하나로, 서인 세력이 광해군과 대북파를 몰아내고 인조인 능양군을 왕위에 앉혔다.", isLocked: false)], currentAlbumImages: [
    AlbumImage(id: .prologueCase1, image: "prologueCase1", title: "단희 창덕궁 감", description: "단희가 창덕궁에 갔다. 눈 앞에는 돈화문으로 보이는 대문이 있다.", isLocked: true),
...
choices: [
    ...
    Choice(text: "장작이 두 개 있었어.", chatType: .onlyText, characterFace: .basic, nextTextIndex: "002", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil),
                        ...
                        */:], currentCharacterNote: [], currentCaseNote: [], currentAlbumImages: [], timelineCheckPoint: [], currentStoryBlockIndex: "")
