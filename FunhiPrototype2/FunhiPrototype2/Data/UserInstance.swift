...
let dummyData = GameData(stories: ["day0":prologueChapter], histories: [1:NoteCase(id: .case101, title: "", shortDescription: "", longDescription: "", isLocked: true)], achivements: [:], gameCharacters: currentCharactersInfo)
