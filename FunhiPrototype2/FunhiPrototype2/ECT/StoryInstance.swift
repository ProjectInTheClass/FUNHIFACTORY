...
var prologueChapter: Episode = Episode(episodeID: "prologue", episodePlace: "현재", episodeYear: 2020, episodeKingYear: "현재 2020년", episodeShortDesciption: "누군가 나에게 내 하루를 바꿀 수 있는, 내 인생을 바꿀 수 있는 구원의 손길을 내밀어 준다면, 나는 그 손을....잡을 수 있을까?", episodeDesciption: "지루하고 따분한, 그저 우울하기만 한 내 인생은 변하긴 할까?\n이런 삶은 이제 그만하고 싶다.\n누군가 나에게 내 하루를 바꿀 수 있는, 내 인생을 바꿀 수 있는 구원의 손길을 내밀어 준다면,\n 나는 그 손을....잡을 수 있을까?", episodePlaceImage: "changdeokgung lllu image", episodeCoverImage: "changdeokgung image sample", isCleared: true, chatHistory: [], storyBlocks: [
    "001":BlockOfDayEpisode(chats:
                            ...
                            choices: [
                                ...
                                Choice(text: "이번은 어떤 내용인가요?", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "078", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil)], achievement: nil, choiceSkip: false, isGodChat: .off),
    "002":BlockOfDayEpisode(chats:
                            ...
                            choices: [
                                ...
                                Choice(text: "광해군이 폐위된 사건이죠?", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "003", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil)], achievement: nil, choiceSkip: false, isGodChat: .off),
    "003":BlockOfDayEpisode(chats:
                            ...
                            choices: [
                                ...
                                Choice(text: "조선 왕 순서를 읊어봐야겠다.", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "006", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil)], achievement: nil, choiceSkip: false, isGodChat: .off),
    ...
    "005":BlockOfDayEpisode(chats:
                            ...
                            choices: [
                                ...
                                Choice(text: "아뇨? 전 이미 전후사정을 다 알고 있는걸요?", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "008", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil)], achievement: nil, choiceSkip: false, isGodChat: .off),
    ...
    "008":BlockOfDayEpisode(chats:
                            ...
                            choices: [Choice(text: "네.", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "009", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil),
                                      Choice(text: "...아니요.", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "010", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil)], achievement: nil, choiceSkip: false, isGodChat: .off),
    "009":BlockOfDayEpisode(chats:
                            ...
                            choices: [
                                ...
                                Choice(text: "", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "End", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil)], achievement: nil, choiceSkip: false, isGodChat: .off),
    ...
    "078":BlockOfDayEpisode(chats:
                                ...
                                Choice(text: "", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "003", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil),
                                            Choice(text: "", likability: [], chatType: .onlyText, characterFace: .basic, nextTextIndex: "선태", achievementToUnlock: nil, infomationToUnlock: nil, gameCharacterToUnlock: nil, caseToUnlock: nil, albumImageToUnlock: nil)], achievement: nil, choiceSkip: false, isGodChat: .off)
...
var chapter4 = Episode(episodeID: "2003", episodePlace: "대조전", episodeYear: 1918, episodeKingYear: "순종 11년", episodeShortDesciption: "", episodeDesciption: "7월 28일임",episodePlaceImage: "changdeokgung lllu image", episodeCoverImage: "changdeokgung image sample", isCleared: false, chatHistory: [], storyBlocks: [
                ...
                ], achievement: nil, choiceSkip: false, isGodChat: .off),
