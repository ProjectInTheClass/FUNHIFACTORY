...
var hwiryeong: GameCharacter = GameCharacter(name: "휘령", profileImage: "cat", backGroundImage: "", infomation: [Infomation(isLocked: true, text: "휘령 정보 1"),Infomation(isLocked: true, text: "휘령 정보 2")], likability: 0)
