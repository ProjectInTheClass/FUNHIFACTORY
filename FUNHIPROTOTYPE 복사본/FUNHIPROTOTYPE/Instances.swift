...
import Foundation
    ...
    let ep001: [Page] = [
        Page(storyText: " 한 나라의 왕인 나는 굵은 포승줄로 묶인 채 고개를 떨궜다. 이 자리에 발을 딛는 것도 이것이 마지막이겠거니 싶었다. 난 그저 초점 없는 눈으로 땅바닥을 바라보며 무릎을 꿇었다.", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 2,  endingScore: 0)], questIdentifier: ""),
        Page(storyText: " 한 나라의 왕인 나는 굵은 포승줄로 묶인 채 고개를 떨궜다. 나는 내가 내뱉는 숨 하나하나를 의심했다. 이게 정녕 꿈이 아닌 것인지, 내가 어찌 이런 처지가 되었는지 말이다. 내가 아버지의 미움을 버티면서까지 겨우 이 자리에 섰는데 이리 되어버린 게 현실이 아니기를 바랐다. 날 이렇게 만든 자들을 결코 용서할 수 없다.", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 2,  endingScore: 0)], questIdentifier: ""),
    ...
    let ep002: [Page] = [
        Page(storyText: "그를 지켜보던 소월신(素月神)은 가볍게 피식 웃고는 시간의 물레방아를 돌렸다. 19바퀴를 돌린 후 멈추고 시간의 한 조각을 꺼내 그에게 지난 과거로 자신이 돌아가는 꿈을 꾸는 도술인 과아귀몽술(過我歸夢術)을 부렸다.", storyImage: nil, choice: [Choice(choiceText: "", nextPageIndex: 666,  endingScore: 0)], questIdentifier: "", endEpisodePage: true)]

    let ep101: [Page] = [
        Page(storyText: " “세자 저하, 감축드리옵니다.”\n\n 동궁에서 나오니 모든 관료들이 나를 향해 축하를 올렸다.\n\n ‘드디어 내가 세자가 되었단 말인가?’", storyImage: nil, choice: [Choice(choiceText: "애써 덤덤한 척 한다. ", nextPageIndex: 1,  endingScore: 0),Choice(choiceText: "행복해 한다.", nextPageIndex: 2,  endingScore: 0),Choice(choiceText: "살짝 미소를 짓는다.", nextPageIndex: 3,  endingScore: 0)], questIdentifier: ""),
    ...
    let ep102: [Page] = [Page(storyText: " 한 내시가 다급하게 나를 불렀다.\n\n “저하, 급히 피란을 가셔야 하옵니다. 떠날 채비를 서두르십시오.”\n\n 급히 채비를 하고 동궁 밖으로 나오자 차가운 새벽 내음이 느껴졌다. 처마를 따라 빗물이 떨어지고 있었다.\n\n ‘아아, 하늘마저 우리의 편이 아닌 것인가.’\n\n 나의 손끝에 스치는 빗물을 따라 냉랭하게 느껴졌다. 아버지를 기다리기 위해 인정전으로 향했다. 인정전에는 이미 모든 벼슬아치들과 마부와 말 등이 대궐 뜰을 가득 메웠다.", storyImage: nil, choice: [
                                Choice(choiceText: "다음.", nextPageIndex: 1,  endingScore: 0)], questIdentifier: ""
    ),Page(storyText: " 비는 그칠 줄을 몰랐다. 아버지와 나는 말을 타고, 소상대비는 뚜껑 있는 교자를 타고 갔다. 홍제원*에 이르자 비는 더 극심히 왔고, 숙의* 이하는 교자를 버리고 말을 탔다.\n 뒤에서는 통곡하는 궁인들의 목소리가 들렸다. 점심을 먹으려고 하니, 반찬은 커녕 밥도 제대로 먹지를 못했다. 급작스레 떠나게 된 피란길이라서 그렇다고 애써 위안 삼았다.", storyImage: nil, choice: [Choice(choiceText: "", nextPageIndex: 666,  endingScore: 0)], questIdentifier: "", endEpisodePage: true)
    ]
    ...
    let ep105 : [Page] = [
        ...
        Page(storyText: "나는 크게 한숨을 들이쉬었다.\n\n‘그래. 어차피 이미 오래전에 겪어봤던 일인데 더 이상 상처받지 말자…….’\n\n……헉.\n\n나는 소스라치게 놀라 뒤로 자빠졌다.\n\n“저하, 괜찮으십니까? 이보게, 얼른 의원을 불러오너라. 저하, 제 목소리가 들리십…….”\n\n나는 계속해서 알 수 없는 일에 정신이 혼미해졌다.", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 4,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: "나는 크게 한숨을 들이쉬었다.\n\n‘그래. 어차피 이미 오래전에 겪어봤던 일인데 더 이상 상처받지 말자…….’\n\n……헉.\n\n나는 소스라치게 놀라 뒤로 자빠졌다.\n\n“저하, 괜찮으십니까? 이보게, 얼른 의원을 불러오너라. 저하, 제 목소리가 들리십…….”\n\n나는 계속해서 알 수 없는 일에 정신이 혼미해졌다.", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 5,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: "‘내가 방금 무어라 했던가? 이미 겪어봤던 일이라고? 아버지께 한 소리를 들어 내 잠시 미친 게 분명하구나. 아니지, 아니야. 아버지께서 날 내치시는 것이 한 두어 번이 아니니 무의식중에 나온 말일 게야…….’\n\n그렇게 깊은 혼란 속으로 빠져버렸고, 그대로 쓰러져 정신을 잃어버렸다.", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 0,  endingScore: 0)], questIdentifier: "", endEpisodePage: true)
    ]
    ...
    let ep106 : [Page] = [
        ...
        Page(storyText: " “당연히 세자 저하 아니십니까? 전하께서도 그리 생각 하실 겁니다.”\n\n“지금 이 상황을 보고도 그리 말할 수가 있느냐? 너도 내가 만만한 거구나.”\n“예? 전혀 아닙니다.”\n\n내 안의 끓어오르는 분노가 느껴졌다. 심장으로부터 열이 나는 것이 생생하게 오감으로 느껴질 지경이었다. 내 몸은 화로 가득해 새빨갛게 변했다.\n\n“됐다. 더 이상 네놈들의 말을 듣고 싶지 않구나. 썩 꺼져라. 어서!”\n\n평소 같았으면 참을 수 있었는데 왜 오늘은 화를 억누를 수 없단 말인가. 나는 내 자신이 혼란스러웠다.", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true)
    ]

    let ep107 : [Page] = [
        Page(storyText: "나는 불안한 생각을 멈출 수가 없었다.\n\n‘나는 어찌해야 할까. 밖으로는 명나라가 나를 세자로 임명할 수 없다고 하고, 안으로는 아버지가 나를 미워하시니……. 만일 새어머니께서 대군을 낳기라도 하시면 내 자리는 위험해지겠지.’", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true)
    ]
    let ep108 : [Page] = [
        Page(storyText: " 내가 우려했던 일이 일어나고야 말았다. 소성대비가 대군을 낳은 것이다.\n\n‘영의정까지 대군의 편에 서 버렸단 말인가?’\n\n이곳에 자신의 편 하나 없다는 사실이 나를 더욱 조마조마하고 위태롭게 만들었다.", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true)
    ]
    let ep109 : [Page] = [
    ...
    let ep110 : [Page] = [
        Page(storyText: " 아버지께 문안 인사를 드리러 동궁 밖으로 나오는데 내인 하나가 급히 말을 전했다.\n\n“지금 전하의 병환이 위급하십니다.”\n\n 나는 말을 듣자마자 수레에서 내려 급히 달려갔다. 약방 내의원들이 입시하고 말을 전하는 내관과 약을 가진 의관들이 침실 밖 대청에 많이 들어와 있었다.\n 정신을 차리지 못하는 아버지를 보니 가슴이 철렁하고 심장이 마구 뛰었다. 이때의 마음은 도대체 무엇이었을지 아직도 깨닫지 못했다.", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 1,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: "아버지께서 일어나질 못하시고 의식이 들지 않으시니, 청심원, 소합원, 강즙 등 약을 번갈아 올렸다. 잠시 뒤, 아버지의 기력이 조금 안정이 되었다. 아버지는 의식을 차리시자마자\n\n“이게 어찌 된 일인가, 어찌 된 일이야.”\n\n 라고 소리치셨다. 나는 손을 저어 좌우를 나가게 하였다. 이에 약방 도제조 이하가 합문 안으로 물러나 대령했다.", storyImage: nil, choice: [Choice(choiceText: "", nextPageIndex: 1,  endingScore: 0)], questIdentifier: "", endEpisodePage: true)
    ]
    let ep111 : [Page] = [
        Page(storyText: " 의관들이 아버지의 증세는 한기가 밖에서 엄습하여 그렇게 된 것이라고 하였다. 오늘은 날씨가 몹시 추우니 한기가 없는 곳에서 정사를 보시면서 몸을 보살피며 치료받는 것이 좋겠다고 하였다.", storyImage: nil, choice: [Choice(choiceText: "", nextPageIndex: 1,  endingScore: 0)], questIdentifier: "", endEpisodePage: true)
    ]
    let ep112 : [Page] = [
        ...
        Page(storyText: " ‘지금 영창대군은 열 살 남짓한데, 지금 아버지께서 돌아가시면 내가 왕이 되는 것 아닌가?’\n\n 참 시기 적절하다. 내 불안한 세자 자리가, 아버지의 위태로움에 더 단단해지는 듯했다. 우스웠다. 한 나라의 왕도 병 앞에서는 어쩔 줄 모르는구나.\n\n 난 세자가 되고 싶다. 그 누구도 의심하지 않는 세자가 되고 싶다. 그럼 비로소 내가 왕이 될 것이니.", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 3,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: " 아버지께서는 내가 죽기 만을 바라시는 걸까?", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true)
    ]
    let ep113 : [Page] = [
        Page(storyText: " 하나 유영경은 이 명령은 여러 사람의 뜻밖에 나온 것이므로 신은 결코 받들 수 없다고 또다시 반대를 하였다.\n\n 궁 내에 이런 떠들썩한 소식이 내게 들리지 않을 리가 있겠는가. 이 소식을 들은 나는…", storyImage: nil, choice: [Choice(choiceText: "다음", nextPageIndex: 1,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: " 머리를 식힐 겸 궁 내를 거닐고 있는데 한 시녀가 울고 있었다.\n\n“무슨 일이냐?”\n\n 시녀는 나를 쳐다보더니 놀라서 재빠르게 허리를 수그렸고, 떨리는 목소리로 말했다.\n\n“저…저하……. 아무 일도 아니 옵니다.”\n“아무 일도 아니라기엔 자네가 울고 있지 않는가?”\n“실은… 동궁 소속의 시녀라는 이유만으로 차별을 당하고 있사옵니다.”\n“그게 무슨 말이냐?”\n“동궁 소속의 시녀들은 모두 무시를 당하고 있사옵니다. 같은 시녀라고 할지라도 맞먹을 수 없다고 하온데….”\n“무시하는 자들은 누구이더냐?”\n“대부분의 궁 안의 자들이며, 심지어는 중궁전의 시녀들까지 기세등등하여 무시를 하고 있사옵니다.”", storyImage: nil, choice: [Choice(choiceText: "심정이 참담하다.", nextPageIndex: 2,  endingScore: 0), Choice(choiceText: "헛웃음만 나오는 이 상황이 재미있다.", nextPageIndex: 3,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: " 지금 내 심정은 참담하기 그지없다.\n\n 아무리 영창대군의 편에 선 자라고 할지라도 엄연히 세자가 있는데도 이리 대놓고 반대를 한다니. 나는 그저 ‘세자’라는 이름만 가진 꼭두각시일 뿐이란 말인가? 나는 여전히 이곳에 홀로 고립되어 있다.", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true),
        Page(storyText: " 대비께서 대군을 낳으시고 내 편엔 아무도 남지 않은 이 상황이 그저 웃기고 어이가 없었다. 난 미친 사람처럼 웃었다. 난 그저 ‘세자’라는 이름만 가진 꼭두각시였다는 사실이 이렇게 뼈 시리게 느껴졌고, 가슴이 욱신거렸다. 가뜩이나 쓸쓸한 이곳이 곱절은 더 외롭게만 느껴졌다. 한참을 웃고 나니 더 가슴이 시렸다.", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true)
    ]
    let ep114 : [Page] = [
        ...
        Page(storyText: " 상소에 대해 아버지는\n\n“정인홍이 세자로 하여금 속히 전위를 받게 하려고 하였으니 그 스스로 모의한 것이 세자에게 충성을 다하는 것이라고 여겼겠지만 실은 불충함이 극심하다. 세자는 반드시 천자의 명을 받은 뒤에 비로소 세자라고 할 수 있다. 지금 세자는 책명을 받지 못했으니 이는 천자도 허락하지 않은 것이고 천하도 알지 못한다.”\n 라고 하셨다. 나는 그 소식을 듣고 인정전으로 달려갔다.", storyImage: nil, choice: [Choice(choiceText: "죽으려고 해도 마음대로 죽지도 못했습니다.", nextPageIndex: 2,  endingScore: 0), Choice(choiceText: "제가 어찌하면 세자로 인정을 하시렵니까?", nextPageIndex: 3,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: " “아바마마, 지난번 갑자기 전위하라는 명을 내리시니 신은 죽으려 해도 죽을 수가 없었나이다.”\n\n 책명을 받지 못한 나는 세자가 될 수 없다. 조정에는 내 편이 없다. 아버지마저 나를 미워하신다. 이런 곳에서 홀로 버틸 수밖에 없는 내가 초라하고 비참하게만 느껴졌다.", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true),
        Page(storyText: " “천자가 허락을 하지 않았어도, 아바마마께서는 인정을 해주실 수 있지 않습니까? 지난번 갑자기 세자로 저를 임명을 하라는 명을 내리시니 신은 죽으려고 해도 죽을 수가 없었나이다. 제가 어찌하면 되겠습니까? 제가 죽으면 그제서야 인정을 하실 겁니까? 신이 도대체 어찌하면 세자로 인정을 하실 겁니까?”\n\n 나는 울부짖었다. 책명 받지 못한 나는 세자가 될 수 없다. 조정도, 아버지도 내 편이 아니다. 이런 곳에서 홀로 버텨야 하는 나 자신이 너무 초라하게만 느껴졌다.", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true)
    ]
    let ep115 : [Page] = [
        Page(storyText: " 빗방울이 보슬보슬 떨어지던, 잠 못 들던 새벽, 나는 침전을 나와 돌계단에 걸터 앉았다. 머리가 축축해지고, 온몸이 젖어 으슬으슬 해지는 게 느껴졌다. 그러던 찰나에, 갑자기 목소리가 들렸다.\n\n‘어차피 네 아비는 곧 죽는다. 대군은 왕위를 이을 수 없어. 네가 왕이 될 것이야.’", storyImage: nil, choice: [Choice(choiceText: "누구냐고 소리친다.", nextPageIndex: 1,  endingScore: 0), Choice(choiceText: "무시한다.", nextPageIndex: 2,  endingScore: 0)], questIdentifier: "", endEpisodePage: false),
        Page(storyText: " 놀란 나는 벌떡 일어나서 소리쳤다.\n\n“누구냐!”\n\n 주위를 둘러보아도 아무도 없었다. 내 귓가에 목소리가 자꾸만 맴돌았다. 여자도, 남자도 아닌 목소리가 머리를 띵하게 만들었다.\n\n‘아버지께서 곧 돌아가신다니. 그게 무슨 말도 안 되는 소리인가?’", storyImage: nil, choice: [], questIdentifier: "", endEpisodePage: true),
